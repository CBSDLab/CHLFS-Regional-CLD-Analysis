...
#   awk -f study_simulate.awk -v MODEL="Regional-CLD-5-1.stmx" -v SCENARIO="Shock-scenario-Regional.csv" study1.csv
#
...
#             Peter S. Hovmand May 4, 2025 to fix path for Stella on HPC
...
NR >1 {
  ...
  TMP="cp " SCENARIO ".csv shock-scenario.csv"
  system(TMP)
